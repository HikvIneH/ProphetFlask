...
def predict():
	...
	if request.method == 'POST':
		...
		num_days = request.form['num_days_ahead']
		num_days_back = request.form['num_days_back']
		...
		#myfile.close()  
	return render_template("home/dashboard-predict.html", original = round(original_end,2), 
